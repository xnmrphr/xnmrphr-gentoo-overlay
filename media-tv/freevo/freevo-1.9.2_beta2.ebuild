...
SRC_URI="http://sourceforge.net/projects/freevo/files/Freevo%20releases/1.9.2b2/freevo-1.9.2b2.tar.bz2"
#SRC_URI="mirror://sourceforge/freevo/files/Freevo%20releases/1.9.2b2/freevo-1.9.2b2.tar.bz2"
...
src_prepare() {
	...
	./autogen.sh || die "Autogen nie dziala"
	epatch "${FILESDIR}/revision.patch"
}
